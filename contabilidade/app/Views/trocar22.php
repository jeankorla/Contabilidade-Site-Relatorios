      ...
      <!-- Imagem de tutorial -->
        ...
        <div id="form-content" style=" padding: 2rem; z-index: 1; margin-top: 5rem;" >
            ...
            <div class="card-body py-5">
              <h1 class="text-center text-white mb-2">Trocar de Contador</h1>
                
              <form action="" method="post" >
               
                <div class="form-outline mb-1">
                  <label class="form-label text-white" for="NAME">Nome</label>
                  <input type="text" id="NAME" name="NAME" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; " />
                ...
                <div class="form-outline mb-1">
                  ...
                  <input type="email" id="EMAIL" name="EMAIL" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; " />
                  
                </div>

                <div class="form-outline mb-1">
                  <label class="form-label text-white" for="CNPJ">CNPJ</label>
                  <input type="number" id="CNPJ" name="CNPJ" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; "/>
                  
                </div>

                <div class="form-outline mb-1">
                  <label class="form-label text-white" for="TEL">Telefone</label>
                  <input type="number" id="TEL" name="TEL" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; "/>
                  
                </div>

                 <div class="form-outline mb-1">
                  <label class="form-label text-white" for="NAME_EMPRESA">Nome da Empresa</label>
                  <input type="text" id="NAME_EMPRESA" name="NAME_EMPRESA" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; "/>
                  
                </div>

                <div class="form-outline mb-1">
                  <label class="form-label text-white" for="FATURA">Faturamento médio mensal</label>
                  <input type="number" id="FATURA" name="FATURA" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; "/>
                  
                </div>

                <div class="form-outline mb-1">
                  <label class="form-label text-white" for="FUNCIONARIOS">Quantidade de Funcionarios</label>
                  <input type="number" id="FUNCIONARIOS" name="FUNCIONARIOS" class="" style="width: 20rem !important; height: 2rem !important; margin: 0 auto !important; "/>
                  
                </div>

                 <div class="form-outline mb-1 text-white">
              <label for="TRIBUTACAO">Tributação</label>
              <select id="TRIBUTACAO" style="width: 20rem !important;">
            ...
            <div class="form-outline mb-1 text-white">
              ...
              <select id="estado" style="width: 20rem !important;">
