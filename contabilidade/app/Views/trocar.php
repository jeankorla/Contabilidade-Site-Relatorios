        ...
        <div class="form-box">
            ...
            <?php endif; ?>
                ...
                <div class="input-group">
                    ...
                    <input type="tel" id="tel" name="tel" placeholder="Digite o seu telefone" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="nome_empresa" name="nome_empresa" placeholder="Digite o Nome de sua empresa" required>
                </div>
