...
<body>
    ...
    <!-- Insira as cláusulas e demais conteúdos conforme necessário -->
    <!-- Exemplo de cláusula -->
    <div class="clausula">
        <p><strong>CLÁUSULA PRIMEIRA:</strong></p><p> O profissional contratado obriga-se a prestar seus serviços profissionais ao contratante, nas seguintes áreas:</p>
        <ul>
