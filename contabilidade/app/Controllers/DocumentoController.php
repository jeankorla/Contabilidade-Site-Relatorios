...
<nav class="navbar navbar-expand-lg navbar-dark mb-4" style="background-color: #024A7F; z-index: 1;">
    <div class="container-fluid navbar-container">
        ...
        <h3>Estamos muito felizes por você escolher nossos serviços. Esperamos atender sempre suas expectativas!</h3>
        <p>Um e-mail com seu contrato foi enviado para ' . $socioEmail . '</p>
