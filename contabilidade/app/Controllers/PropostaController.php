        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12 col-md">
                <div class="text-wrapper">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-2" style="font-size: 4rem;"><strong><strong><span style="color: #FF931E;">Proposta Cliente</span></strong> ' . $empresa['nome'] . '</strong></h1>
                    <div class="text-wrapper">
