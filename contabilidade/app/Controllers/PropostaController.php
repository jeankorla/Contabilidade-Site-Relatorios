        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12 col-md">
                <div class="text-wrapper">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-2" style="font-size: 3rem;"><strong><strong><span style="color: #FF931E;">Proposta Cliente:  </span></strong> ' . $empresa['nome'] . '</strong></h1>
                    <div class="text-wrapper">
...
<br><strong>4.4 </strong>– Sem prejuízo do previsto no item 4.3, os honorários poderão ser aumentados de comum acordo entre as partes, conforme volume de aumento do trabalho executado pela contabilidade.&nbsp;<br></p>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-4">
                <div class="image-wrapper">
                    <img src="https://sccontab.com.br/propostas/assets/images/ass.webp" alt="ASS">
                </div>
            </div>
        </div>
    </div>
