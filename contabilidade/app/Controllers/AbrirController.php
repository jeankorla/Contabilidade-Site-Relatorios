                        ...
                        <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                ...
                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                    <tr>
                                        <td align="left" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, , helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px"><span style="font-size:15px">Olá [nome],<br><br>&nbsp;É um imenso prazer dar as boas-vindas à [EMPRESA] como nosso futuro cliente na Spolaor Contabilidade.<br><br>Estamos entusiasmados com a parceria promissora que se inicia!🎉</span>&nbsp;<br><br><span style="font-size:15px">A seguir, apresentamos os serviços que oferecemos para alavancar o sucesso da sua empresa.<br>&nbsp;<br><a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:15px" href="https://sccontab.com.br/apresentacao">Clique aqui para acessar a nossa apresentação</a></span></p>
                                        <ul>
